                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_slo" class="form-control"
                                                            required="" value="{{ $products->product_name_slo }}">
                                                        @error('product_name_slo')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_slo"
                                                            class="form-control"
                                                            value="{{ $products->product_tags_slo }}"
                                                            data-role="tagsinput" required="">
                                                        @error('product_tags_slo')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_slo"
                                                            class="form-control"
                                                            value="{{ $products->product_size_slo }}"
                                                            data-role="tagsinput">
                                                        @error('product_size_slo')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_slo"
                                                            class="form-control"
                                                            value="{{ $products->product_color_slo }}"
                                                            data-role="tagsinput" required="">
                                                        @error('product_color_slo')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
		...
		{!! $products->short_desc_en !!}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="short_desc_slo" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_desc_slo !!}
	</textarea>
                                                    </div>
                                                </div>
		...
		{!! $products->long_desc_en !!}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor2" name="long_desc_slo" rows="10" cols="80">
		{!! $products->long_desc_slo !!}
						</textarea>
                                                    </div>
                                                </div>
                        ...
                        <form method="post" action="{{ route('update-product-thambnail') }}"
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="card">
                                        <img src="/frontend/images/products/thumbs/{{ $products->product_thumbnail }}"
                                            class="card-img-top" style="height: 130px;">
                                        <div class="card-body">
