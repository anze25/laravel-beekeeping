                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_slo" class="form-control"
                                                            value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_slo"
                                                            class="form-control" value="red,Black,Large"
                                                            data-role="tagsinput" required="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="short_desc_slo" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>
                                                    </div>
                                                </div>
