                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Blog Post List <span class="badge badge-pill badge-danger">
                                    ...
                                    <tbody>
                                        @foreach ($blogpost as $item)
                                            <tr>
                                                ...
                                                <td> <img src="/frontend/images/posts/thumbs/{{ $item->post_image }}"
                                                        style="width: 60px; height: 60px;"> </td>
                                                <td>{{ $item->post_title_en }}</td>
                                                <td>{{ $item->post_title_slo }}</td>
                                                <td width="20%">
                                                    <a href="{{ route('blog.post.edit', $item->id) }}" class="btn btn-info"
                                                        title="Edit Data"><i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="{{ route('blog.post.delete', $item->id) }}"
