...
<li> <img src="/frontend/images/products/thumbs/{{ $product->product_thumbnail }}" style="width: 30px; height: 30px;"> {{ $item->product_name_en }}  </li>
@endforeach
                        ...
                        <a href="{{ url('product/details/' . $item->id . '/' . $item->product_slug_en) }}">
                            <div class="list border-bottom"> <img
                                ...
                                <div class="d-flex flex-column ml-3" style="margin-left: 10px;">
                                    <span>{{ $item->product_name_en }} </span> <small>
