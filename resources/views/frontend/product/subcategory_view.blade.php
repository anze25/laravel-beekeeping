...
@section('title')
    @if (session()->get('language') == 'slovenian')
        Kategorija: {{ $category->category_name_slo }}
    @else
            ...
            <div class="col-12 col-lg-9">
                @if (session()->get('language') == 'slovenian')
                    <div class="category-top justify-content-end">
                        <div class="mr-auto">
                            Število artiklov: {{ $productsCount }}
                        </div>
                        ...
                        <div class="sort-by"> <span>Sortiraj po:</span> <span>
                                <select name="sortBy" id="sortBy" class="form-control" model='sortBy'>
                                    ...
                                    <option value="product_name_slo" @if ($sortBy == '	product_name_slo') selected @endif>
                                        A->Ž
                                    </option>
                                    <option value="product_name_slo_desc"
                                        @if ($sortBy == 'product_name_slo_desc') selected @endif>Ž->A
                                    </option>
                                    <option value="date" @if ($sortBy == 'date') selected @endif>Novejši
                                        naprej
                                    <option value="date-desc" @if ($sortBy == 'date-desc') selected @endif>Starejši
                                        naprej
                                    </option>
                        ...
                        <div class="show-item"> <span>Prikaži:</span> <span>
                                <select name="pageSize" id="pageSize" class="form-control">
                                    ...
                                    <option value="9" @if ($pageSize == 9) selected @endif>9 izdelkov
                                    </option>
                ...
                @else
                    <div class="category-top justify-content-end">
                        ...
                        <div class="sort-by"> <span>Sort by:</span> <span>
                                <select name="sortBy" id="sortBy" class="form-control" model='sortBy'>
                                    <option value="product_name_en" @if ($sortBy == '	product_name_en') selected @endif>
                                        A->Z
                                    </option>
                                    <option value="product_name_en_desc"
                                        @if ($sortBy == 'product_name_en_desc') selected @endif>Z->A
                                    </option>
                                    <option value="date" @if ($sortBy == 'date') selected @endif>Newest
                                        first
                                    </option>
                ...
                <div class="left-block left-menu">
                    ...
                    <ul>
                        @foreach ($categories as $productCategory)
                            <li
                                class="{{ request()->is('category/product/' . $productCategory->id) ? 'active' : '' }}">
