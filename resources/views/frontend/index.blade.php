...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
    <div class="container">
                                                    ...
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a
                                                                    ...
                                                                    <img src="/frontend/images/products/thumbs/{{ $product->product_thumbnail }}"
                                                                        alt=""> </a> </div>
                                                            <!-- /.image -->
              ...
              <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Shoes</a></li> -->
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if (session()->get('language') == 'slovenian')
                            {{ $skip_category_0->category_name_slo }}
                        @else
        ...
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
@if (session()->get('language') == 'slovenian') {{ $skip_category_1->category_name_slo }} @else {{ $skip_category_1->category_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@if (session()->get('language') == 'slovenian') {{ $product->product_name_slo }} @else {{ $product->product_name_en }} @endif
            </a></h3>
          <div class="rating rateit-small"></div>
          <div class="description"></div>
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        ...
                                        <div class="blog-post-info text-left">
                                            ...
                                            <p class="text">
                                                @if (session()->get('language') == 'slovenian')
                                                    {!! Str::limit($blog->post_details_slo, 100) !!}
                                                @else
