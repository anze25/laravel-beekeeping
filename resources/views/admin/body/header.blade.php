                    ...
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle" data-toggle="dropdown"
                        ...
                        <i>
                            @if (session()->get('language') == 'slovenian')
                                <img src="{{ asset('frontend/assets/images/slo.png') }}" alt="" srcset="">
                            @else
                                <img src="{{ asset('frontend/assets/images/eng.png') }}" alt="" srcset="">
                            @endif
                        </i>
                    </a>
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="{{ route('slovenian.language') }}"><i><img
                                        src="{{ asset('frontend/assets/images/slo.png') }}" alt=""
                                        srcset=""></i> Slovenian</a>

                            <a class="dropdown-item" href="{{ route('english.language') }}"><i><img
                                        src="{{ asset('frontend/assets/images/eng.png') }}" alt=""
                                        srcset=""></i> English</a>
